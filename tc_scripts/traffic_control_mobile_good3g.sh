...
############
tc filter add dev enp1s0f0  parent 1: protocol ip prio 1 u32 match ip dport 9222  0xffff flowid 1:12
tc filter add dev enp1s0f0  parent 1: protocol ip prio 1 u32 match ip sport 9222  0xffff flowid 1:12
#tc filter add dev enp1s0f0 parent ffff: protocol ip basic match "cmp(u16 at 0 layer transport lt 9221) and cmp(u16 at 0 layer transport gt 9223)" flowid 1:11 action mirred egress redirect dev ifb0
